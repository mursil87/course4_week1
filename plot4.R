...
plot(dat5$dat3.dt,dat5$Voltage,type = "n",xlab="datetime",ylab="Voltage")
lines(dat5$dat3.dt,dat5$Voltage)
...
plot(dat5$dat3.dt,dat5$Global_reactive_power,type = "n",xlab="datetime",ylab="Global_reactive_power")
lines(dat5$dat3.dt,dat5$Global_reactive_power)
